...
- **2025-12-28** — [SCREAMING_SNAKE_CASE](./2025-12-28_screaming_snake_case.py)
    - It is supposed to like that `Camel to Snake` thing I did, but I mess up the capitalization of the letter.
...
- **2026-03-05** — [Smallest Gap](./2026-03-05_smallest_gap.py)
    - Who would have thought that I just did the `Palindrome Characters` yesterday and it helps me a lot, although I did it in brute force way, I got nothing to think because it is already solved. Perhaps I should learn how to program it the most efficient way? Hold up, that is my job in the first place (I am unemployed), I guess.
...
- **2026-03-15** — [Captured Chess Pieces](./2026-03-15_captured_chess_pieces.py)
    - The easiest chess related program I did.
...
- **2026-04-14** — [Last Letter](./2026-04-14_last_letter.py)
